  ...
  const loadTerms = async () => {
    try {
      ...
      if (apiService.isMockMode()) {
        setContent("ეს არის მოკლე ტექსტი სერვისის პირობების შესახებ.");
        setLoading(false);
        return;
      }

      const response = await apiService.getTerms("service");
      ...
      console.error("Error loading service terms:", err);
