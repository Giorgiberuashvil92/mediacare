...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  ka: {
    ...
    "auth.register.confirmPassword.placeholder": "გაიმეორე პაროლი",
    ...
    "doctor.location.placeholder": "თბილისი",
    "doctor.workingLanguage.label": "სამუშაო ენა",
    "doctor.workingLanguage.placeholder": "მაგ: ქართული, ინგლისური",
  ...
  en: {
    ...
    "doctor.location.placeholder": "Tbilisi",
    "doctor.workingLanguage.label": "Working Language",
    "doctor.workingLanguage.placeholder": "e.g., Georgian, English",
